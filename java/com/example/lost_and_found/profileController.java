...
//        int passwordSize = passwordField.getText().length();
...
//        passwordField.setText(Session.getPassword());
        ...
        //first load all fields then copy them
    ...
    public void onClickChanges(ActionEvent event) throws Exception{
        ...
        if (!fullNameField.getText().isEmpty() && !emailField.getText().isEmpty() && !pass.isEmpty() && !studentIdField.getText().isEmpty() && !phoneField.getText().isEmpty()){
            String profileImgName = Session.getProfileImage(); // existing
            ...
            Session.setUser(Session.getUserId(), studentIdField.getText(),
                    ...
                    profileImgName);  // ← file name, not path
...
//        if (passwordToggle.isSelected()) {
//            // ✅ sirf text copy karo — field mat chhupao
//            passwordVisible.setText(passwordField.getText());
//            passwordField.setText("");  // ← sirf content clear karo
//        } else {
//            // ✅ sirf text copy karo — field mat chhupao
//            passwordField.setText(passwordVisible.getText());
////            passwordVisible.setText("");  // ← sirf content clear karo
//        }
    }
    public void cancelChanges(ActionEvent event){
        ...
        if (passwordToggle.isSelected()) {
            ...
            passwordVisible.setVisible(true);
            passwordVisible.setManaged(true);
            passwordField.setText("");         // ✅ null nahi ""
//            passwordField.setVisible(false);
            passwordField.setManaged(false);
        } else {
            ...
            passwordField.setVisible(true);
            passwordField.setManaged(true);
            passwordVisible.setText("");       // ✅ clear karo
            passwordVisible.setVisible(false);
            passwordVisible.setManaged(false);
        }
    }
