...
//    @FXML private TableColumn<usersModel, String> category;
//    @FXML private TableColumn<usersModel, String> image;
//    @FXML private TableColumn<usersModel, String> item;
//    @FXML private TableColumn<usersModel, String> location;
//    @FXML private TableColumn<usersModel, String> status;
//    @FXML private TableColumn<usersModel, String> type;
...
//                HelloApplication.class.getResource("styleLogin.css").toExternalForm()
//        );
...
//        image.setCellValueFactory(new PropertyValueFactory<>("image_path"));
...
//        matchControl control = new matchControl();
        ...
        try {
            view();
//            control.displayMatchRecords();

            // ✅ setup selection directly here
//            for (Button btn : buttons) {
//                btn.setOnAction(e -> {
//                    for (Button b : buttons) {
//                        b.getStyleClass().remove("categoryBarSelect");
//                        if (b == btn) {
//                            b.getStyleClass().add("categoryBarSelect");
//                        }
//                    }
//                });
//            }
...
//            recordBox.getChildren().add(createRow(item));
//        }
        ...
        // ⚠️ NOTE: Aapne view method mein cell factories dobara set nahi kiye
        // YEH SAHI HAI kyunki initialize() mein already set ho chuke hain!
...
//        tableView.setItems(list);
    ...
    // ✅ NEW METHOD (reusable scene switch)
...
//        // ya selection ma css ma nhi kr skta ku ka yaha javafx avoid krta ha wo sirf
//        // #categoryBar:hover   { }   /* ✅ works */
//        //#categoryBar:pressed { }   /* ✅ works — only WHILE held down */
//        //#categoryBar:focused { }
//        //allow krta ha
//
//        for (Button btn : buttons) {
...
//                }
//                // add to clicked
//                btn.getStyleClass().add("categoryBarSelect");
//            });
//        }
//    }
