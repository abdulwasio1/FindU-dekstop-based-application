...
public class queriesAdmin {
    ...
    public ObservableList<itemModel> getItems() throws Exception {
        ...
        getUsers(); //just to update total users at the starting bcz starting ma load recent items hi load hoga dashboard ma
    ...
    public ObservableList<usersModel> getUsers() throws Exception {
        ...
        PreparedStatement psUser = connection.getCon().prepareStatement(
                "SELECT user_id, name, email, password, phone, role, s_id, profile_image " +
                        "FROM lost_found_db.users WHERE user_id != ?"  // ← current user exclude
        );
        ...
        while (rsUser.next()) {
            ...
            uModel.setProfile_image(rsUser.getString("profile_image"));  // ← add karo
...
//    public ObservableList<matchModel> getMatches() throws Exception {
//        int matchCount = 0;
//        ObservableList<matchModel> totalMatchList = FXCollections.observableArrayList();
//        connection.setUpCon();
//        PreparedStatement psMatch = connection.getCon().prepareStatement(
...
//            match.setScore(rsMatch.getInt(1));
//            match.setStatus(rsMatch.getString(2));
//            match.setMatchId(rsMatch.getInt(3));
//            match.setMatchDate(rsMatch.getString(4));
//            match.setLostItemName(rsMatch.getString(5));
//            match.setLostLocation(rsMatch.getString(6));
//            match.setLostContact(rsMatch.getString(7));
//            match.setFoundItemName(rsMatch.getString(8));
//            match.setFoundLocation(rsMatch.getString(9));
//            match.setFoundContact(rsMatch.getString(10));
//            totalMatchList.add(match);
//            matchCount++;
//        }
//
